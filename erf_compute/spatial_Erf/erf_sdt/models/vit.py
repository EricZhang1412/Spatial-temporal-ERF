...
class VisionTransformer_attn(nn.Module):
    """ Vision Transformer attention blocks for testing 
...
@register_model
def vit_tiny_patch16_224_relu(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ ViT-Tiny (Vit-Ti/16)
    """
    model_args = dict(patch_size=16, embed_dim=192, depth=12, num_heads=3, act_layer='relu')
    model = _create_vision_transformer('vit_tiny_patch16_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
@register_model
def test_vit_attention(pretrained: bool = False, **kwargs) -> VisionTransformer_attn:
    """ ViT Test
    """
    model_args = dict(
        patch_size=16, embed_dim=96, depth=9, num_heads=3, mlp_ratio=3,
    ...
    model = _create_vision_transformer('test_vit_attention', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
